...
const {isLoggedIn, isAuthor, validateCampgrounds}=require('../midddleware')
...
router.post('/',upload.array('image'), validateCampgrounds, catchAsync(campgrounds.createCampground))
